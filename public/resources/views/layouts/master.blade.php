...
<head>
	...
	<!-- mean menu css -->
	<link rel="stylesheet" href="{{ asset('assets/site/css/meanmenu.min.css') }}">
	<!-- main style -->
...
<body>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li class="{{ request()->is('home') ? 'current-list-item' : '' }}"><a href="{{ route('home') }}">Home</a></li>
								<li class="{{ request()->is('about') ? 'current-list-item' : '' }}"><a href="{{ route('about') }}">About</a></li>
								<li class="{{ request()->is('product') ? 'current-list-item' : '' }}"><a href="{{ route('product') }}">Products</a></li>
								<li class="{{ request()->is('contact') ? 'current-list-item' : '' }}"><a href="{{ route('contact') }}">Contact</a></li>
								<li class="{{ request()->is('dashboard') ? 'current-list-item' : '' }}"><a href="{{ route('dashboard') }}">Dashboard</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2025 - <a href="">Raad Jaber</a>,  All Rights Reserved.<br>
				...
				<div class="col-lg-6 text-right col-md-12">
					<div class="social-icons">
						<ul>
							<li><a href="https://www.facebook.com/raed.jaber.54943" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
							<li><a href="https://www.linkedin.com/in/raad-jaber-547a01239/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
	...
	<!-- isotope -->
	<script src="{{ asset('assets/site/js/jquery.isotope-3.0.6.min.js') }}"></script>
	<!-- waypoints -->
	<script src="{{ asset('assets/site/js/waypoints.js') }}"></script>
	<!-- owl carousel -->
	...
	<!-- sticker js -->
	<script src="{{ asset('assets/site/js/sticker.js') }}"></script>
	<!-- main js -->
